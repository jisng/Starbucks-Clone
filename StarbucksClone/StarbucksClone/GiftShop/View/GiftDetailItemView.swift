...
class GiftDetailItemView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        setUI()
        setLayout()
        plusButton.addTarget(self, action: #selector(didTapAction(_:)), for: .touchUpInside)
    }
    
    @objc func didTapAction(_ button: UIButton) {
        print("눌림")
    }
    ...
    private func setLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            itemSubtitleLabel.leadingAnchor.constraint(equalTo: self.leadingAnchor),
            itemSubtitleLabel.trailingAnchor.constraint(equalTo: self.trailingAnchor),
            ...
            itemPriceLabel.leadingAnchor.constraint(equalTo: self.leadingAnchor),
            ...
            minusButton.widthAnchor.constraint(equalTo: self.widthAnchor, multiplier: 0.1),
            ...
            addButton.widthAnchor.constraint(equalTo: self.widthAnchor, multiplier: 0.48),
            ...
            presentButton.widthAnchor.constraint(equalTo: self.widthAnchor, multiplier: 0.48),
