...
//    func setNotiController() {
//        if notificationController == nil {
//
//            notificationController = NotificationViewController()
//            view.insertSubview(notificationController.view, at: 1)
...
//    }
    ...
    @objc func didTapButton(_ sender: UIButton) {
        ...
        levelVC.navigationBar.barStyle = .black
        levelVC.navigationBar.backgroundColor = .black
        levelVC.navigationBar.tintColor = .white
        levelVC.navigationBar.titleTextAttributes = [
